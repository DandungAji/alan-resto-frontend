...
<template>
  <div class="bg-white rounded-sm shadow-sm p-5 h-full flex flex-col">
    ...
    <div class="mt-4 pt-4">
      ...
      <button class="w-full bg-blue-500 text-white font-bold py-3 rounded-sm text-lg hover:bg-blue-600 transition-colors">
