...
<template>
  ...
  >
    <div
      class="bg-white p-8 rounded-lg shadow-xl w-full max-w-sm text-center transform transition-all"
    >
      <div
      ...
      <h3 class="text-xl leading-6 font-medium text-gray-900">Saved!</h3>
      <div class="mt-2 px-4 py-3">
        <p class="text-base text-gray-600">
          Pesanan berhasil disimpan dengan nomor pesanan:
        </p>
